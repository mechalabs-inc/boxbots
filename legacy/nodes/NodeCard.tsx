...
//   const localTransition = nodeState?.transition ||
//     data.transition || {
//       smooth: true,
//       smoothness: 50,
//     };
//   const localLED = nodeState?.led ||
//     data.led || {
//       color: "#ff0000",
//       brightness: 100,
//     };
...
//     return (
//       <div
//         className={`node-card min-w-[280px] max-w-[320px] relative transition-all ${
...
//                 {
//                   name:
//                     jointNames[localJoints.length] ||
//                     `joint_${localJoints.length}`,
//                   value: 0,
//                 },
//               ];
//               updateNodeJoints(id, newJoints);
...
//                   updateNodeTransition(id, {
//                     ...localTransition,
//                     smooth: checked as boolean,
//                   })
//                 }
