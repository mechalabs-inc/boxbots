...
// } from "@/store/useJointStore";
// import { toast } from "sonner";
// import { SaveTemplateDialog } from "../src/components/SaveTemplateDialog";
...
//   const [animationAbortController, setAnimationAbortController] =
...
//           name,
//           value:
//             typeof storeJointValues[name] === "number"
//               ? storeJointValues[name]
//               : 0,
//         }));
...
//       const seededJoints: JointParameter[] = (availableJointsStore || []).map(
//         (name) => ({
//           name,
//           value:
//             typeof storeJointValues[name] === "number"
//               ? (storeJointValues as any)[name]
//               : 0,
//         })
//       );
...
//       toast.error(
//         "No starting node found. Add a node without incoming connections."
//       );
//       return;
//     }
...
//       if (!nodeState) {
//         return {
//           nextJointPose: prevJointPose,
//           nextLEDState: prevLEDState,
//           skipNext: false,
//         };
//       }
...
//         console.log(
//           `LED: RGB(${finalR}, ${finalG}, ${finalB}) at ${nodeState.led.brightness}% brightness`
//         );
...
//           const durationMs =
//             maxDuration -
//             (trans.smoothness / 100) * (maxDuration - minDuration);
...
//           for (
//             let frame = 0;
//             frame <= totalFrames && !abortController.signal.aborted;
//             frame++
//           ) {
...
//             );
//             const brightness =
//               prevLEDState.brightness +
//               (nextLEDState.brightness - prevLEDState.brightness) * easedT;
...
//             const interpolatedHex = `#${r.toString(16).padStart(2, "0")}${g
//               .toString(16)
//               .padStart(2, "0")}${b.toString(16).padStart(2, "0")}`;
//             useJointStore
//               .getState()
//               .setCurrentLEDState({ color: interpolatedHex, brightness });
...
//               toast.error(
//                 "Transition nodes cannot be directly connected to parallel branches"
//               );
//               break;
//             }
...
//               const joints =
//                 nodeState?.joints ||
//                 ((node.data as any)?.joints as JointParameter[] | undefined);
//               if (joints && joints.length > 0) {
//                 // Only apply pose if switching from a different node
//                 if (prevFocused !== node.id) {
//                   const pose = Object.fromEntries(
//                     joints.map((j) => [j.name, j.value])
